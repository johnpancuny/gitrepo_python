# -*- coding: utf-8 -*-
"""
Created on Tue Sep  4 01:23:24 2018

@author: Jun Pan Fall 2018 MSDS
"""
...
def exercise06():
    ...
    print('wage_per_hour', wage_per_hour)
...
def exercise07():
    ...
    wage = 17.0
    print('wage',wage)
    data_type_wage = type(wage)
    print('data_type_wage', data_type_wage)
    for doubled in range(0,2):
        print('wage', wage)
    # ------ Place code above here /\ /\ /\ ------
    return wage, doubled
...
def exercise11():
    ...
    mp.dps = 10    # set number of digits which is equal to 10 
    print(mp.pi)
    # ------ Place code above here /\ /\ /\ ------
    return pi
...
def exercise13():
    ...
    r = 7
    pi = 3.14159
    volume_shpere = 4/3*pi*r**3
    print('volume_sphere', volume_shpere)
    # ------ Place code above here /\ /\ /\ ------
